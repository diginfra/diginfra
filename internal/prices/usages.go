...
// PopulateActualCosts fetches cloud provider reported costs from the Diginfra
...
// from the Diginfra Cloud Usage API for each supported resource in the project
