...
func TestLookupModule(t *testing.T) {
	...
	tests := []struct {
		...
		{"module-d", &tfconfig.ModuleCall{Source: "app.terraform.io/diginfra/ec2-instance/aws"}, toStore["module-d"], ""},
