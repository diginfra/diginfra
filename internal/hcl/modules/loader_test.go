...
import (
	...
	"github.com/diginfra/diginfra/internal/credentials"
	sync2 "github.com/diginfra/diginfra/internal/sync"
)
...
func testLoaderE2E(t *testing.T, path string, expectedModules []*ManifestModule, opts TestLoaderE2EOpts) {
	if opts.Cleanup {
		err := os.RemoveAll(filepath.Join(path, config.DiginfraDir))
	...
	testLoaderE2E(t, "./testdata/nested_modules", []*ManifestModule{
		{
			...
			Version:     "3.4.0",
			Dir:         ".diginfra/terraform_modules/f8b5f5ddb85ee755b31c8b76d2801f5b",
		...
		},
		{
			...
			Dir:    ".diginfra/terraform_modules/9740179dc58fea6ce4a32fdc5b4e0839",
		},
		{
		...
		},
		{
			...
			Version:     "3.1.0",
			Dir:         ".diginfra/terraform_modules/b72552bcaa63a49783f9a735a697c662",
		...
		},
		{
			...
			Dir:    ".diginfra/terraform_modules/db69103dcf4b9586b710a97de31750bd",
		},
		{
	...
	testLoaderE2E(t, "./testdata/submodules", []*ManifestModule{
		{
			...
			Version:     "2.5.0",
			Dir:         ".diginfra/terraform_modules/d1e3bab8b33f57431ace737ccffbf67f/modules/zones",
		...
		},
		{
			...
			Version:     "2.5.0",
			Dir:         ".diginfra/terraform_modules/d1e3bab8b33f57431ace737ccffbf67f/modules/records",
			DownloadURL: "git::https://github.com/terraform-aws-modules/terraform-aws-route53?ref=97dfbae914056b1a06c213be5d5834bc7eea8433",
		},
		{
			Key:    "git-submodule",
			Source: "git::https://github.com/terraform-aws-modules/terraform-aws-route53.git//modules/zones",
			Dir:    ".diginfra/terraform_modules/03c49f2fce2b8552355561b7ac4f2c94/modules/zones",
		},
	}, TestLoaderE2EOpts{Cleanup: true})
}
...
func TestModuleMultipleUsesMissingManifest(t *testing.T) {
	...
	err := os.Remove("./testdata/module_multiple_uses/.diginfra/terraform_modules/manifest.json")
	if !assert.NoError(t, err) {
		t.FailNow()
	}
...
func TestWithCachedModules(t *testing.T) {
	...
	regModContents, err := os.ReadFile("./testdata/with_cached_modules/.diginfra/terraform_modules/f8b5f5ddb85ee755b31c8b76d2801f5b/main.tf")
	if !assert.NoError(t, err) {
		t.FailNow()
	}

	gitModContents, err := os.ReadFile("./testdata/with_cached_modules/.diginfra/terraform_modules/9740179dc58fea6ce4a32fdc5b4e0839/main.tf")
	if !assert.NoError(t, err) {
		t.FailNow()
	}
...
func TestSourceMapGitModule(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "git without version",
			sourceMap: config.TerraformSourceMap{
				"git::https://github.com/terraform-aws-modules/terraform-aws-ec2-instance.git": "git::https://github.com/diginfra-tests/terraform-aws-ec2-instance.git",
			},
			want: []*ManifestModule{
				{
					Key:     "git-module",
					Source:  "git::https://github.com/diginfra-tests/terraform-aws-ec2-instance.git?ref=v3.4.0",
					Version: "",
				},
			},
		},
		{
			...
			sourceMap: config.TerraformSourceMap{
				"git::https://github.com/terraform-aws-modules/": "git::https://github.com/diginfra-tests/",
			},
			want: []*ManifestModule{
				{
					Key:     "git-module",
		...
		},
		{
			...
			sourceMap: config.TerraformSourceMap{
				"git::https://github.com/terraform-aws-modules/terraform-aws-ec2-instance.git?ref=v3.4.0": "git::https://github.com/diginfra-tests/terraform-aws-ec2-instance.git?ref=master",
				"git::https://github.com/terraform-aws-modules/terraform-aws-ec2-instance.git":            "git::https://github.com/diginfra-tests/terraform-aws-ec2-instance.git",
			},
			want: []*ManifestModule{
				{
					Key:     "git-module",
					Source:  "git::https://github.com/diginfra-tests/terraform-aws-ec2-instance.git?ref=master",
					Version: "",
				},
			},
		},
...
func TestSourceMapGitSubmodule(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "git without version",
			sourceMap: config.TerraformSourceMap{
				"git::https://github.com/terraform-aws-modules/terraform-aws-route53.git": "git::https://github.com/diginfra-tests/terraform-aws-route53.git",
			},
			want: []*ManifestModule{
				{
					Key:     "git-submodule",
					Source:  "git::https://github.com/diginfra-tests/terraform-aws-route53.git//modules/zones?ref=v2.5.0",
					Version: "",
				},
			},
		},
		...
		},
		{
			name: "git with ref override",
			sourceMap: config.TerraformSourceMap{
				"git::https://github.com/terraform-aws-modules/terraform-aws-route53.git?ref=v2.5.0": "git::https://github.com/diginfra-tests/terraform-aws-route53.git?ref=master",
				"git::https://github.com/terraform-aws-modules/terraform-aws-route53.git":            "git::https://github.com/diginfra-tests/terraform-aws-route53.git",
			},
			want: []*ManifestModule{
				{
					Key:     "git-submodule",
					Source:  "git::https://github.com/diginfra-tests/terraform-aws-route53.git//modules/zones?ref=master",
					Version: "",
				},
			},
		},
