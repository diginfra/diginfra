...
import (
	...
	"github.com/diginfra/diginfra/internal/hcl/funcs"
...
type Block struct {
	...
	HCLBlock *hcl.Block
	// UniqueAttrs specifies diginfra specific unique attributes that will be appended to the block values.
...
func (b BlockBuilder) NewBlock(filename string, rootPath string, hclBlock *hcl.Block, ctx *Context, parent *Block, moduleBlock *Block) *Block {
	...
	isLoggingVerbose := strings.TrimSpace(os.Getenv("DIGINFRA_HCL_DEBUG_VERBOSE")) == "true"
...
func newArnAttribute(addressSha, name string, withCount bool, withEach bool) *hcl.Attribute {
	...
	// Diginfra will try and parse this region later down the line.
...
func (b *Block) values() cty.Value {
	...
	// as the repercussions for this change could be quite vast. See https://github.com/diginfra/diginfra/issues/2596 for
	// more information.
	if b.Type() == "provider" {
