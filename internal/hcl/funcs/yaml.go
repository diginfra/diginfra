...
// YAMLDecodeFunc is an Diginfra specific version of the yaml.YAMLDecodeFunc
// which handles Diginfra mocked return values. If the argument passed to YAMLDecodeFunc
