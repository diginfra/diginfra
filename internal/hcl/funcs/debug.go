...
// LogArgs is identical to PrintArgs but writes the arguments to the Diginfra log.
...
//
//	root_block_device {
//		volume_size = diginfralog("test", "foo")
//	}
//
// will log:
//
