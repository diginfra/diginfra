...
// MergeFunc is an Diginfra specific version of collection.MergeFunc which
// handles Diginfra mocked return values. If the argument contains an Diginfra mock
