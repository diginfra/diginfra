...
func createTestFile(filename, contents string) string {
	dir, err := os.MkdirTemp(os.TempDir(), "diginfra")
	if err != nil {
		panic(err)
	}
...
`,
	...
	assert.JSONEq(
		...
		`[
			...
			{"foo":"10.0.0.0","bar":"input-diginfra-mock-44956be29f34"},
			{"foo":"10.0.1.0","bar":"input-diginfra-mock-44956be29f34"}
		]`,
		values,
	)
}
...
data "aws_subnets" "example" {
	...
	assertBlockEqualsJSON(
		t,
		`{"ids":["subnet-1-diginfra-mock-44956be29f34", "subnet-2-diginfra-mock-44956be29f34", "subnet-3-diginfra-mock-44956be29f34"]}`,
...
`,
	...
	assertBlockEqualsJSON(
		t,
		`{"config":{"instance_type":"m5.4xlarge", "tags": "config-diginfra-mock-44956be29f34"}}`,
		moduleBlock.Values(),
	...
	assertBlockEqualsJSON(
		t,
		`{"instance_type":"m5.4xlarge", "tags": "config-diginfra-mock-44956be29f34"}`,
		resource.Values(),
		"id", "arn", "self_link", "name",
	)
}
...
`,
	...
	assertBlockEqualsJSON(
		t,
		`{"foo":0, "tags":"tags-diginfra-mock-44956be29f34"}`,
		resource.Values(),
		"id", "arn", "self_link", "name",
	)
}
