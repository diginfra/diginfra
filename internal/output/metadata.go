...
// Metadata holds common information used to identify the system that Diginfra is run within.
type Metadata struct {
	DiginfraCommand string `json:"diginfraCommand"`
