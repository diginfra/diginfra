...
type resourceWithFloat struct {
	MyFloat *float64 `diginfra_usage:"my_float"`
}

type resourceWithString struct {
	MyString *string `diginfra_usage:"my_string"`
}

type resourceWithInt struct {
	MyInt *int64 `diginfra_usage:"my_int"`
}

type resourceWithSubUsage struct {
	MySubUsage *subUsageResource `diginfra_usage:"my_sub_usage"`
}
