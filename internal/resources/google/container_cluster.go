...
type ContainerCluster struct {
	...
	// "usage" args
	DefaultNodePoolNodes        *int64   `diginfra_usage:"nodes"`
	AutopilotVCPUCount          *float64 `diginfra_usage:"autopilot_vcpu_count"`
	AutopilotMemoryGB           *float64 `diginfra_usage:"autopilot_memory_gb"`
	AutopilotEphemeralStorageGB *float64 `diginfra_usage:"autopilot_ephemeral_storage_gb"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the ContainerCluster.
