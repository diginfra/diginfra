...
type CloudRunService struct {
	...
	AverageRequestDurationMs      *int64 `diginfra_usage:"average_request_duration_ms"`
	ConcurrentRequestsPerInstance *int64 `diginfra_usage:"concurrent_requests_per_instance"`
	InstanceHrs                   *int64 `diginfra_usage:"instance_hrs"`
}
