...
type StorageBucketNetworkEgressUsage struct {
	SameContinent *float64 `diginfra_usage:"same_continent"`
	Asia          *float64 `diginfra_usage:"asia"`
	Worldwide     *float64 `diginfra_usage:"worldwide"`
	China         *float64 `diginfra_usage:"china"`
...
type ComputeVPNGatewayNetworkEgressUsage struct {
	SameRegion   *float64 `diginfra_usage:"same_region"`
	USOrCanada   *float64 `diginfra_usage:"us_or_canada"`
	Europe       *float64 `diginfra_usage:"europe"`
	Asia         *float64 `diginfra_usage:"asia"`
	SouthAmerica *float64 `diginfra_usage:"south_america"`
	Oceania      *float64 `diginfra_usage:"oceania"`
	Worldwide    *float64 `diginfra_usage:"worldwide"`
