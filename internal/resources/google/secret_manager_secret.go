...
type SecretManagerSecret struct {
	...
	// "usage" args
	ActiveSecretVersions         *int64 `diginfra_usage:"active_secret_versions"`
	MonthlyAccessOperations      *int64 `diginfra_usage:"monthly_access_operations"`
	MonthlyRotationNotifications *int64 `diginfra_usage:"monthly_rotation_notifications"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the SecretManagerSecret.
