...
type BigQueryTable struct {
	Address                   string
	Region                    string
	MonthlyStreamingInsertsMB *float64 `diginfra_usage:"monthly_streaming_inserts_mb"`
	MonthlyStorageWriteAPIGB  *float64 `diginfra_usage:"monthly_storage_write_api_gb"`
	MonthlyStorageReadAPITB   *float64 `diginfra_usage:"monthly_storage_read_api_tb"`
	MonthlyActiveStorageGB    *float64 `diginfra_usage:"monthly_active_storage_gb"`
	MonthlyLongTermStorageGB  *float64 `diginfra_usage:"monthly_long_term_storage_gb"`
}
