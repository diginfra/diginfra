...
type ArtifactRegistryRepository struct {
	...
	MonthlyEgressDataTransferGB *RegionsUsage `diginfra_usage:"monthly_egress_data_transfer_gb"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the ArtifactRegistryRepository.
