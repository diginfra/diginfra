...
type RegionsUsage struct {
	...
	AsiaEast2              *float64 `diginfra_usage:"asia_east2"`
	AsiaNortheast1         *float64 `diginfra_usage:"asia_northeast1"`
	AsiaNortheast2         *float64 `diginfra_usage:"asia_northeast2"`
	AsiaNortheast3         *float64 `diginfra_usage:"asia_northeast3"`
	AsiaSouth1             *float64 `diginfra_usage:"asia_south1"`
	AsiaSouth2             *float64 `diginfra_usage:"asia_south2"`
	AsiaSoutheast1         *float64 `diginfra_usage:"asia_southeast1"`
	AsiaSoutheast2         *float64 `diginfra_usage:"asia_southeast2"`
	AustraliaSoutheast1    *float64 `diginfra_usage:"australia_southeast1"`
	AustraliaSoutheast2    *float64 `diginfra_usage:"australia_southeast2"`
	EuropeCentral2         *float64 `diginfra_usage:"europe_central2"`
	EuropeNorth1           *float64 `diginfra_usage:"europe_north1"`
	EuropeWest1            *float64 `diginfra_usage:"europe_west1"`
	EuropeWest2            *float64 `diginfra_usage:"europe_west2"`
	EuropeWest3            *float64 `diginfra_usage:"europe_west3"`
	EuropeWest4            *float64 `diginfra_usage:"europe_west4"`
	EuropeWest6            *float64 `diginfra_usage:"europe_west6"`
	NorthAmericaNortheast1 *float64 `diginfra_usage:"northamerica_northeast1"`
	NorthAmericaNortheast2 *float64 `diginfra_usage:"northamerica_northeast2"`
	SouthAmericaEast1      *float64 `diginfra_usage:"southamerica_east1"`
	SouthAmericaWest1      *float64 `diginfra_usage:"southamerica_west1"`
	USCentral1             *float64 `diginfra_usage:"us_central1"`
	USEast1                *float64 `diginfra_usage:"us_east1"`
	USEast4                *float64 `diginfra_usage:"us_east4"`
	USWest1                *float64 `diginfra_usage:"us_west1"`
	USWest2                *float64 `diginfra_usage:"us_west2"`
	USWest3                *float64 `diginfra_usage:"us_west3"`
	USWest4                *float64 `diginfra_usage:"us_west4"`
}
...
func (r RegionsUsage) Values() []RegionUsage {
	...
	for i := 0; i < s.NumField(); i++ {
		...
		regions = append(regions, RegionUsage{
			Key:   underscore.ReplaceAllString(t.Field(i).Tag.Get("diginfra_usage"), "-"),
...
func GetFloatFieldValueByUsageTag(tagValue string, s interface{}) float64 {
	...
	for i := 0; i < rt.NumField(); i++ {
		f := rt.Field(i)
		v := strings.Split(f.Tag.Get("diginfra_usage"), ",")[0] // use split to ignore tag "options" like omitempty, etc.
		if v == tagValue {
			r := reflect.ValueOf(s)
