...
type FrontdoorFirewallPolicy struct {
	...
	// "usage" args
	MonthlyCustomRuleRequests     *int64 `diginfra_usage:"monthly_custom_rule_requests"`
	MonthlyManagedRulesetRequests *int64 `diginfra_usage:"monthly_managed_ruleset_requests"`
}
