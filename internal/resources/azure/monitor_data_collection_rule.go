...
type MonitorDataCollectionRule struct {
	...
	MonthlyCustomMetricsSamplesGB *int64 `diginfra_usage:"monthly_custom_metrics_samples"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the MonitorDataCollectionRule.
