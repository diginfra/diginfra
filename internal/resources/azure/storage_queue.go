...
type StorageQueue struct {
	...
	MonthlyStorageGB                    *float64 `diginfra_usage:"monthly_storage_gb"`
	MonthlyClass1Operations             *int64   `diginfra_usage:"monthly_class_1_operations"`
	MonthlyClass2Operations             *int64   `diginfra_usage:"monthly_class_2_operations"`
	MonthlyGeoReplicationDataTransferGB *float64 `diginfra_usage:"monthly_geo_replication_data_transfer_gb"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the StorageQueue.
