...
type AppConfiguration struct {
	...
	MonthlyAdditionalRequests *int64 `diginfra_usage:"monthly_additional_requests"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the AppConfiguration.
