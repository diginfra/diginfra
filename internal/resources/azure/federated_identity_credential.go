...
type FederatedIdentityCredential struct {
	...
	MonthlyActiveP1Users *int64 `diginfra_usage:"monthly_active_p1_users"`
	MonthlyActiveP2Users *int64 `diginfra_usage:"monthly_active_p2_users"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the FederatedIdentityCredential.
