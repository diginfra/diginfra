...
type LogicAppStandard struct {
	...
	SKU                             *string `diginfra_usage:"sku"`
	MonthlyStandardConnectorCalls   *int64  `diginfra_usage:"monthly_standard_connector_calls"`
	MonthlyEnterpriseConnectorCalls *int64  `diginfra_usage:"monthly_enterprise_connector_calls"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the LogicAppStandard.
