...
type StorageAccount struct {
	...
	// "usage" args
	MonthlyStorageGB                        *float64 `diginfra_usage:"storage_gb"`
	MonthlyIterativeReadOperations          *int64   `diginfra_usage:"monthly_iterative_read_operations"`
	MonthlyReadOperations                   *int64   `diginfra_usage:"monthly_read_operations"`
	MonthlyIterativeWriteOperations         *int64   `diginfra_usage:"monthly_iterative_write_operations"`
	MonthlyWriteOperations                  *int64   `diginfra_usage:"monthly_write_operations"`
	MonthlyListAndCreateContainerOperations *int64   `diginfra_usage:"monthly_list_and_create_container_operations"`
	MonthlyOtherOperations                  *int64   `diginfra_usage:"monthly_other_operations"`
	MonthlyDataRetrievalGB                  *float64 `diginfra_usage:"monthly_data_retrieval_gb"`
	MonthlyDataWriteGB                      *float64 `diginfra_usage:"monthly_data_write_gb"`
	BlobIndexTags                           *int64   `diginfra_usage:"blob_index_tags"`
	DataAtRestStorageGB                     *float64 `diginfra_usage:"data_at_rest_storage_gb"`
	SnapshotsStorageGB                      *float64 `diginfra_usage:"snapshots_storage_gb"`
	MetadataAtRestStorageGB                 *float64 `diginfra_usage:"metadata_at_rest_storage_gb"`
	EarlyDeletionGB                         *float64 `diginfra_usage:"early_deletion_gb"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the StorageAccount.
