...
type MonitorDiagnosticSetting struct {
	...
	MonthlyPlatformLogGB *int64 `diginfra_usage:"monthly_platform_log_gb"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the MonitorDiagnosticSetting.
