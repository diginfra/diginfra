...
type NetworkWatcherFlowLog struct {
	...
	MonthlyLogsCollectedGB *float64 `diginfra_usage:"monthly_logs_collected_gb"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the NetworkWatcherFlowLog.
