...
type DataFactoryIntegrationRuntimeSelfHosted struct {
	...
	// "usage" args
	MonthlyOrchestrationRuns *int64 `diginfra_usage:"monthly_orchestration_runs"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the DataFactoryIntegrationRuntimeSelfHosted.
