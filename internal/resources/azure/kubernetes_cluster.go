...
type KubernetesCluster struct {
	...
	LoadBalancer                  *KubernetesClusterLoadBalancer    `diginfra_usage:"load_balancer"`
	DefaultNodePool               *KubernetesClusterDefaultNodePool `diginfra_usage:"default_node_pool"`
}

type KubernetesClusterLoadBalancer struct {
	MonthlyDataProcessedGB *int64 `diginfra_usage:"monthly_data_processed_gb"`
}

type KubernetesClusterDefaultNodePool struct {
	Nodes        *int64   `diginfra_usage:"nodes"`
