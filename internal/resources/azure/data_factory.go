...
type DataFactory struct {
	...
	// "usage" args
	MonthlyReadWriteOperationEntities  *int64 `diginfra_usage:"monthly_read_write_operation_entities"`
	MonthlyMonitoringOperationEntities *int64 `diginfra_usage:"monthly_monitoring_operation_entities"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the DataFactory.
