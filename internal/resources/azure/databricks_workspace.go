...
type DatabricksWorkspace struct {
	...
	Region                         string
	SKU                            string
	MonthlyAllPurposeComputeDBUHrs *int64 `diginfra_usage:"monthly_all_purpose_compute_dbu_hrs"`
	MonthlyJobsComputeDBUHrs       *int64 `diginfra_usage:"monthly_jobs_compute_dbu_hrs"`
	MonthlyJobsLightComputeDBUHrs  *int64 `diginfra_usage:"monthly_jobs_light_compute_dbu_hrs"`
}
