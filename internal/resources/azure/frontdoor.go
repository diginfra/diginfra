...
type Frontdoor struct {
	...
	// "usage" args
	MonthlyInboundDataTransferGB  *float64                            `diginfra_usage:"monthly_inbound_data_transfer_gb"`
	MonthlyOutboundDataTransferGB *frontdoorOutboundDataTransferUsage `diginfra_usage:"monthly_outbound_data_transfer_gb"`
}
...
type frontdoorOutboundDataTransferUsage struct {
	USGovZone1MonthlyTransferGB *float64 `diginfra_usage:"us_gov"`
	Zone1MonthlyTransferGB      *float64 `diginfra_usage:"north_america_europe_africa"`
	Zone2MonthlyTransferGB      *float64 `diginfra_usage:"asia_pacific"`
	Zone3MonthlyTransferGB      *float64 `diginfra_usage:"south_america"`
	Zone4MonthlyTransferGB      *float64 `diginfra_usage:"australia"`
	Zone5MonthlyTransferGB      *float64 `diginfra_usage:"india"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the Frontdoor.
