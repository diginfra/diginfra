...
type ServiceBusNamespace struct {
	...
	// Usage-based fields
	MonthlyMessagingOperations *int64 `diginfra_usage:"monthly_messaging_operations"`
	MonthlyBrokeredConnections *int64 `diginfra_usage:"monthly_brokered_connections"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the ServiceBusNamespace.
