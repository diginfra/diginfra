...
type SecurityCenterSubscriptionPricing struct {
	...
	MonthlyServersPlan1Nodes *float64 `diginfra_usage:"monthly_servers_plan_1_nodes"`
	MonthlyServersPlan2Nodes *float64 `diginfra_usage:"monthly_servers_plan_2_nodes"`

	MonthlyContainersVCores        *float64 `diginfra_usage:"monthly_containers_vcores"`
	MonthlyContainerRegistryImages *float64 `diginfra_usage:"monthly_container_registry_images"`

	MonthlySQLAzureConnectedInstances *float64 `diginfra_usage:"monthly_sql_azure_connected_instances"`
	MonthlySQLOutsideAzureVCores      *float64 `diginfra_usage:"monthly_sql_outside_azure_vcores"`
	MonthlyMySQLInstances             *float64 `diginfra_usage:"monthly_mysql_instances"`
	MonthlyPostgreSQLInstances        *float64 `diginfra_usage:"monthly_postgresql_instances"`
	MonthlyMariaDBInstances           *float64 `diginfra_usage:"monthly_mariadb_instances"`
	CosmosDBRequestUnits              *float64 `diginfra_usage:"cosmosdb_request_units"`

	MonthlyStorageAccounts *float64 `diginfra_usage:"monthly_storage_accounts"`

	MonthlyAppServiceNodes  *float64 `diginfra_usage:"monthly_app_service_nodes"`
	MonthlyKeyVaults        *int64   `diginfra_usage:"monthly_key_vaults"`
	MonthlyARMSubscriptions *int64   `diginfra_usage:"monthly_arm_subscriptions"`
	MonthlyDNSQueries       *int64   `diginfra_usage:"monthly_dns_queries"`

	MonthlyKubernetesCores *float64 `diginfra_usage:"monthly_kubernetes_cores"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the SecurityCenterSubscriptionPricing.
