...
type CognitiveAccountSpeech struct {
	...
	// Speech to text
	MonthlySpeechToTextStandardHrs                                   *float64 `diginfra_usage:"monthly_speech_to_text_standard_hrs"`
	MonthlySpeechToTextBatchHrs                                      *float64 `diginfra_usage:"monthly_speech_to_text_standard_batch_hrs"`
	MonthlySpeechToTextCustomModelHrs                                *float64 `diginfra_usage:"monthly_speech_to_text_custom_hrs"`
	MonthlySpeechToTextCustomModelBatchHrs                           *float64 `diginfra_usage:"monthly_speech_to_text_custom_batch_hrs"`
	MonthlySpeechToTextCustomEndpointHrs                             *float64 `diginfra_usage:"monthly_speech_to_text_custom_endpoint_hrs"`
	MonthlySpeechToTextConversationTranscriptionMultiChannelAudioHrs *float64 `diginfra_usage:"monthly_speech_to_text_conversation_transcription_multi_channel_audio_hrs"`
	MonthlySpeechToTextCustomTrainingHrs                             *float64 `diginfra_usage:"monthly_speech_to_text_custom_training_hrs"`
	MonthlySpeechToTextEnhancedAddOnsHrs                             *float64 `diginfra_usage:"monthly_speech_to_text_enhanced_add_ons_hrs"`

	// Text to speech
	MonthlyTextToSpeechNeuralChars             *int64   `diginfra_usage:"monthly_text_to_speech_neural_chars"`
	MonthlyTextToSpeechCustomNeuralTrainingHrs *float64 `diginfra_usage:"monthly_text_to_speech_custom_neural_training_hrs"`
	MonthlyTextToSpeechCustomNeuralChars       *int64   `diginfra_usage:"monthly_text_to_speech_custom_neural_chars"`
	MonthlyTextToSpeechCustomNeuralEndpointHrs *float64 `diginfra_usage:"monthly_text_to_speech_custom_neural_endpoint_hrs"`
	MonthlyTextToSpeechLongAudioChars          *int64   `diginfra_usage:"monthly_text_to_speech_long_audio_chars"`
	MonthlyTextToSpeechPersonalVoiceProfiles   *int64   `diginfra_usage:"monthly_text_to_speech_personal_voice_profiles"`
	MonthlyTextToSpeechPersonalVoiceChars      *int64   `diginfra_usage:"monthly_text_to_speech_personal_voice_chars"`

	// Speech translation
	MonthlySpeechTranslationHrs *float64 `diginfra_usage:"monthly_speech_translation_hrs"`

	// Speaker recognition
	MonthlySpeakerVerificationTransactions   *int64 `diginfra_usage:"monthly_speaker_verification_transactions"`
	MonthlySpeakerIdentificationTransactions *int64 `diginfra_usage:"monthly_speaker_identification_transactions"`

	// Voice storage
	MonthlyVoiceProfiles *int64 `diginfra_usage:"monthly_voice_profiles"`

	// Standard commitment tier
	MonthlyCommitmentSpeechToTextHrs                      *int64   `diginfra_usage:"monthly_commitment_speech_to_text_standard_hrs"`
	MonthlyCommitmentSpeechToTextOverageHrs               *float64 `diginfra_usage:"monthly_commitment_speech_to_text_standard_overage_hrs"`
	MonthlyCommitmentSpeechToTextCustomModelHrs           *int64   `diginfra_usage:"monthly_commitment_speech_to_text_custom_hrs"`
	MonthlyCommitmentSpeechToTextCustomModelOverageHrs    *float64 `diginfra_usage:"monthly_commitment_speech_to_text_custom_overage_hrs"`
	MonthlyCommitmentSpeechToTextEnhancedAddOnsHrs        *int64   `diginfra_usage:"monthly_commitment_speech_to_text_enhanced_add_ons_hrs"`
	MonthlyCommitmentSpeechToTextEnhancedAddOnsOverageHrs *float64 `diginfra_usage:"monthly_commitment_speech_to_text_enhanced_add_ons_overage_hrs"`
	MonthlyCommitmentTextToSpeechNeuralCommitmentChars    *int64   `diginfra_usage:"monthly_commitment_text_to_speech_neural_commitment_chars"`
	MonthlyCommitmentTextToSpeechNeuralOverageChars       *int64   `diginfra_usage:"monthly_commitment_text_to_speech_neural_overage_chars"`

	// Connected container
	MonthlyConnectedContainerCommitmentSpeechToTextHrs                      *int64   `diginfra_usage:"monthly_connected_container_commitment_speech_to_text_standard_hrs"`
	MonthlyConnectedContainerCommitmentSpeechToTextOverageHrs               *float64 `diginfra_usage:"monthly_connected_container_commitment_speech_to_text_standard_overage_hrs"`
	MonthlyConnectedContainerCommitmentSpeechToTextCustomModelHrs           *int64   `diginfra_usage:"monthly_connected_container_commitment_speech_to_text_custom_hrs"`
	MonthlyConnectedContainerCommitmentSpeechToTextCustomModelOverageHrs    *float64 `diginfra_usage:"monthly_connected_container_commitment_speech_to_text_custom_overage_hrs"`
	MonthlyConnectedContainerCommitmentSpeechToTextEnhancedAddOnsHrs        *int64   `diginfra_usage:"monthly_connected_container_commitment_speech_to_text_enhanced_add_ons_hrs"`
	MonthlyConnectedContainerCommitmentSpeechToTextEnhancedAddOnsOverageHrs *float64 `diginfra_usage:"monthly_connected_container_commitment_speech_to_text_enhanced_add_ons_overage_hrs"`
	MonthlyConnectedContainerCommitmentTextToSpeechNeuralCommitmentChars    *int64   `diginfra_usage:"monthly_connected_container_commitment_text_to_speech_neural_commitment_chars"`
	MonthlyConnectedContainerCommitmentTextToSpeechNeuralOverageChars       *int64   `diginfra_usage:"monthly_connected_container_commitment_text_to_speech_neural_overage_chars"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the CognitiveAccountSpeech.
