...
type TrafficManagerProfile struct {
	...
	MonthlyTrafficViewDataPoints *int64 `diginfra_usage:"monthly_traffic_view_data_points"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the TrafficManagerProfile.
