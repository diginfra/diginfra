...
type AutomationAccount struct {
	Address                 string
	Region                  string
	MonthlyJobRunMins       *int64 `diginfra_usage:"monthly_job_run_mins"`
	NonAzureConfigNodeCount *int64 `diginfra_usage:"non_azure_config_node_count"`
	MonthlyWatcherHrs       *int64 `diginfra_usage:"monthly_watcher_hrs"`
}
