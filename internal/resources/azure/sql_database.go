...
type SQLDatabase struct {
	...
	ExtraDataStorageGB *float64 `diginfra_usage:"extra_data_storage_gb"`
	...
	MonthlyVCoreHours *int64 `diginfra_usage:"monthly_vcore_hours"`
	...
	LongTermRetentionStorageGB *int64 `diginfra_usage:"long_term_retention_storage_gb"`
	...
	BackupStorageGB *int64 `diginfra_usage:"backup_storage_gb"`
}
