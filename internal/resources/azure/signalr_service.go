...
type SignalRService struct {
	...
	MonthlyAdditionalMessages *int64 `diginfra_usage:"monthly_additional_messages"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the SignalRService.
