...
type CognitiveDeployment struct {
	...
	MonthlyLanguageInputTokens     *int64   `diginfra_usage:"monthly_language_input_tokens"`
	MonthlyLanguageOutputTokens    *int64   `diginfra_usage:"monthly_language_output_tokens"`
	MonthlyCodeInterpreterSessions *int64   `diginfra_usage:"monthly_code_interpreter_sessions"`
	MonthlyBaseModelTokens         *int64   `diginfra_usage:"monthly_base_model_tokens"`
	MonthlyFineTuningTrainingHours *float64 `diginfra_usage:"monthly_fine_tuning_training_hours"`
	MonthlyFineTuningHostingHours  *float64 `diginfra_usage:"monthly_fine_tuning_hosting_hours"`
	MonthlyFineTuningInputTokens   *int64   `diginfra_usage:"monthly_fine_tuning_input_tokens"`
	MonthlyFineTuningOutputTokens  *int64   `diginfra_usage:"monthly_fine_tuning_output_tokens"`
	MonthlyStandard10241024Images  *int64   `diginfra_usage:"monthly_standard_1024_1024_images"`
	MonthlyStandard10241792Images  *int64   `diginfra_usage:"monthly_standard_1024_1792_images"`
	MonthlyHD10241024Images        *int64   `diginfra_usage:"monthly_hd_1024_1024_images"`
	MonthlyHD10241792Images        *int64   `diginfra_usage:"monthly_hd_1024_1792_images"`
	MonthlyTextEmbeddingTokens     *int64   `diginfra_usage:"monthly_text_embedding_tokens"`
	MonthlyTextToSpeechCharacters  *int64   `diginfra_usage:"monthly_text_to_speech_characters"`
	MonthlyTextToSpeechHours       *float64 `diginfra_usage:"monthly_text_to_speech_hours"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the CognitiveDeployment.
