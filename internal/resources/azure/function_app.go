...
type FunctionApp struct {
	...
	MonthlyExecutions   *int64 `diginfra_usage:"monthly_executions"`
	ExecutionDurationMs *int64 `diginfra_usage:"execution_duration_ms"`
...
// It uses the `diginfra_usage` struct tags to populate data into the FunctionApp
