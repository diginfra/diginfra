...
var (
	// unsupportedLegacySkus represents skus that Diginfra doesn't support because these skus are
...
type LogAnalyticsWorkspace struct {
	...
	MonthlyArchivedDataGB               *float64 `diginfra_usage:"monthly_archive_data_gb"`
	MonthlyArchivedDataRestoredGB       *float64 `diginfra_usage:"monthly_archive_data_restored_gb"`
	MonthlyArchivedDataSearchedGB       *float64 `diginfra_usage:"monthly_archive_data_searched_gb"`
	MonthlyBasicLogDataIngestionGB      *float64 `diginfra_usage:"monthly_basic_log_data_ingestion_gb"`
	MonthlyBasicLogSearchGB             *float64 `diginfra_usage:"monthly_basic_log_search_gb"`
	MonthlyLogDataIngestionGB           *float64 `diginfra_usage:"monthly_log_data_ingestion_gb"`
	MonthlyAdditionalLogDataRetentionGB *float64 `diginfra_usage:"monthly_additional_log_data_retention_gb"`
	MonthlyLogDataExportGB              *float64 `diginfra_usage:"monthly_log_data_export_gb"`
	MonthlySentinelDataIngestionGB      *float64 `diginfra_usage:"monthly_sentinel_data_ingestion_gb"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the LogAnalyticsWorkspace.
