...
type CognitiveAccountLanguage struct {
	...
	MonthlyLanguageTextAnalyticsRecords *int64 `diginfra_usage:"monthly_language_text_analytics_records"`
	MonthlyLanguageSummarizationRecords *int64 `diginfra_usage:"monthly_language_summarization_records"`

	MonthlyLanguageConversationalLanguageUnderstandingRecords               *int64   `diginfra_usage:"monthly_language_conversational_language_understanding_records"`
	MonthlyLanguageConversationalLanguageUnderstandingAdvancedTrainingHours *float64 `diginfra_usage:"monthly_language_conversational_language_understanding_advanced_training_hours"`
	MonthlyLanguageCustomizedTextClassificationRecords                      *int64   `diginfra_usage:"monthly_language_customized_text_classification_records"`
	MonthlyLanguageCustomizedSummarizationRecords                           *int64   `diginfra_usage:"monthly_language_customized_summarization_records"`
	MonthlyLanguageCustomizedQuestionAnsweringRecords                       *int64   `diginfra_usage:"monthly_language_customized_question_answering_records"`
	MonthlyLanguageCustomizedTrainingHours                                  *float64 `diginfra_usage:"monthly_language_customized_training_hours"`
	MonthlyLanguageTextAnalyticsForHealthRecords                            *int64   `diginfra_usage:"monthly_language_text_analytics_for_health_records"`

	// Commitment tiers
	MonthlyCommitmentLanguageTextAnalyticsRecords                          *int64 `diginfra_usage:"monthly_commitment_language_text_analytics_records"`
	MonthlyCommitmentLanguageTextAnalyticsOverageRecords                   *int64 `diginfra_usage:"monthly_commitment_language_text_analytics_overage_records"`
	MonthlyCommitmentLanguageSummarizationRecords                          *int64 `diginfra_usage:"monthly_commitment_language_summarization_records"`
	MonthlyCommitmentLanguageSummarizationOverageRecords                   *int64 `diginfra_usage:"monthly_commitment_language_summarization_overage_records"`
	MonthlyConnectedContainerCommitmentLanguageTextAnalyticsRecords        *int64 `diginfra_usage:"monthly_connected_container_commitment_language_text_analytics_records"`
	MonthlyConnectedContainerCommitmentLanguageTextAnalyticsOverageRecords *int64 `diginfra_usage:"monthly_connected_container_commitment_language_text_analytics_overage_records"`
	MonthlyConnectedContainerCommitmentLanguageSummarizationRecords        *int64 `diginfra_usage:"monthly_connected_container_commitment_language_summarization_records"`
	MonthlyConnectedContainerCommitmentLanguageSummarizationOverageRecords *int64 `diginfra_usage:"monthly_connected_container_commitment_language_summarization_overage_records"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the CognitiveAccountLanguage.
