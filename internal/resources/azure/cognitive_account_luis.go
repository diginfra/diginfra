...
type CognitiveAccountLUIS struct {
	...
	MonthlyLUISTextRequests                                    *int64 `diginfra_usage:"monthly_luis_text_requests"`
	MonthlyLUISSpeechRequests                                  *int64 `diginfra_usage:"monthly_luis_speech_requests"`
	MonthlyCommitmentLUISTextRequests                          *int64 `diginfra_usage:"monthly_commitment_luis_text_requests"`
	MonthlyCommitmentLUISTextOverageRequests                   *int64 `diginfra_usage:"monthly_commitment_luis_text_overage_requests"`
	MonthlyConnectedContainerCommitmentLUISTextRequests        *int64 `diginfra_usage:"monthly_connected_container_commitment_luis_text_requests"`
	MonthlyConnectedContainerCommitmentLUISTextOverageRequests *int64 `diginfra_usage:"monthly_connected_container_commitment_luis_text_overage_requests"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the CognitiveAccountLUIS.
