...
type VirtualMachine struct {
	...
	StorageOSDisk              *StorageOSDiskUsage   `diginfra_usage:"storage_os_disk"`
	StorageDataDisk            *StorageDataDiskUsage `diginfra_usage:"storage_data_disk"`
}

type StorageOSDiskUsage struct {
	MonthlyDiskOperations *int64 `diginfra_usage:"monthly_disk_operations"`
}
