...
type VirtualMachineScaleSet struct {
	...
	StorageProfileOSDisk   *StorageProfileOSDiskUsage `diginfra_usage:"storage_profile_os_disk"`
	StorageProfileDataDisk *StorageProfileOSDiskUsage `diginfra_usage:"storage_profile_data_disk"`
}
