...
type DirectoryServiceDirectory struct {
	...
	AdditionalDomainControllers *float64 `diginfra_usage:"additional_domain_controllers"`
	...
	SharedAccounts *float64 `diginfra_usage:"shared_accounts"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the DirectoryServiceDirectory.
