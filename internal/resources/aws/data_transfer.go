...
type DataTransfer struct {
	...
	// "usage" args
	MonthlyInfraRegionGB            *float64 `diginfra_usage:"monthly_intra_region_gb"`
	MonthlyOutboundInternetGB       *float64 `diginfra_usage:"monthly_outbound_internet_gb"`
	MonthlyOutboundUsEastToUsEastGB *float64 `diginfra_usage:"monthly_outbound_us_east_to_us_east_gb"`
	MonthlyOutboundOtherRegionsGB   *float64 `diginfra_usage:"monthly_outbound_other_regions_gb"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the DataTransfer.
