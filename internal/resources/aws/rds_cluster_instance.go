...
type RDSClusterInstance struct {
	...
	MonthlyCPUCreditHrs                          *int64   `diginfra_usage:"monthly_cpu_credit_hrs"`
	VCPUCount                                    *int64   `diginfra_usage:"vcpu_count"`
	MonthlyAdditionalPerformanceInsightsRequests *int64   `diginfra_usage:"monthly_additional_performance_insights_requests"`
