...
type EBSSnapshot struct {
	...
	Region                   string
	SizeGB                   *float64
	MonthlyListBlockRequests *int64 `diginfra_usage:"monthly_list_block_requests"`
	MonthlyGetBlockRequests  *int64 `diginfra_usage:"monthly_get_block_requests"`
	MonthlyPutBlockRequests  *int64 `diginfra_usage:"monthly_put_block_requests"`
	FastSnapshotRestoreHours *int64 `diginfra_usage:"fast_snapshot_restore_hours"`
}
