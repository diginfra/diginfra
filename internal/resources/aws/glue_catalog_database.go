...
type GlueCatalogDatabase struct {
	...
	MonthlyObjects  *float64 `diginfra_usage:"monthly_objects"`
	MonthlyRequests *float64 `diginfra_usage:"monthly_requests"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the GlueCatalogDatabase.
