...
type RedshiftCluster struct {
	...
	NodeType                     string
	Nodes                        *int64
	ManagedStorageGB             *float64 `diginfra_usage:"managed_storage_gb"`
	ExcessConcurrencyScalingSecs *int64   `diginfra_usage:"excess_concurrency_scaling_secs"`
	SpectrumDataScannedTB        *float64 `diginfra_usage:"spectrum_data_scanned_tb"`
	BackupStorageGB              *float64 `diginfra_usage:"backup_storage_gb"`
}
