...
type CloudwatchEventBus struct {
	Address                      string
	Region                       string
	MonthlySchemaDiscoveryEvents *int64   `diginfra_usage:"monthly_schema_discovery_events"`
	MonthlyCustomEvents          *int64   `diginfra_usage:"monthly_custom_events"`
	MonthlyThirdPartyEvents      *int64   `diginfra_usage:"monthly_third_party_events"`
	MonthlyArchiveProcessingGB   *float64 `diginfra_usage:"monthly_archive_processing_gb"`
	ArchiveStorageGB             *float64 `diginfra_usage:"archive_storage_gb"`
}
