...
type RegionsUsage struct {
	...
	USGovEast1   *float64 `diginfra_usage:"us_gov_east_1"`
	USEast1      *float64 `diginfra_usage:"us_east_1"`
	USEast2      *float64 `diginfra_usage:"us_east_2"`
	USWest1      *float64 `diginfra_usage:"us_west_1"`
	USWest2      *float64 `diginfra_usage:"us_west_2"`
	USWest2Lax1  *float64 `diginfra_usage:"us_west_2_lax_1"`
	CACentral1   *float64 `diginfra_usage:"ca_central_1"`
	CAWest1      *float64 `diginfra_usage:"ca_west_1"`
	CNNorth1     *float64 `diginfra_usage:"cn_north_1"`
	CNNorthwest1 *float64 `diginfra_usage:"cn_northwest_1"`
	EUCentral1   *float64 `diginfra_usage:"eu_central_1"`
	EUWest1      *float64 `diginfra_usage:"eu_west_1"`
	EUWest2      *float64 `diginfra_usage:"eu_west_2"`
	EUSouth1     *float64 `diginfra_usage:"eu_south_1"`
	EUWest3      *float64 `diginfra_usage:"eu_west_3"`
	EUNorth1     *float64 `diginfra_usage:"eu_north_1"`
	ILCentral1   *float64 `diginfra_usage:"il_central_1"`
	APEast1      *float64 `diginfra_usage:"ap_east_1"`
	APNortheast1 *float64 `diginfra_usage:"ap_northeast_1"`
	APNortheast2 *float64 `diginfra_usage:"ap_northeast_2"`
	APNortheast3 *float64 `diginfra_usage:"ap_northeast_3"`
	APSoutheast1 *float64 `diginfra_usage:"ap_southeast_1"`
	APSoutheast2 *float64 `diginfra_usage:"ap_southeast_2"`
	APSoutheast3 *float64 `diginfra_usage:"ap_southeast_3"`
	APSoutheast4 *float64 `diginfra_usage:"ap_southeast_4"`
	APSoutheast5 *float64 `diginfra_usage:"ap_southeast_5"`
	APSouth1     *float64 `diginfra_usage:"ap_south_1"`
	MESouth1     *float64 `diginfra_usage:"me_south_1"`
	SAEast1      *float64 `diginfra_usage:"sa_east_1"`
	AFSouth1     *float64 `diginfra_usage:"af_south_1"`
}
