...
type S3IntelligentTieringStorageClass struct {
	...
	// "usage" args
	FrequentAccessStorageGB            *float64 `diginfra_usage:"frequent_access_storage_gb"`
	InfrequentAccessStorageGB          *float64 `diginfra_usage:"infrequent_access_storage_gb"`
	ArchiveAccessStorageGB             *float64 `diginfra_usage:"archive_access_storage_gb"`
	DeepArchiveAccessStorageGB         *float64 `diginfra_usage:"deep_archive_access_storage_gb"`
	MonitoredObjects                   *int64   `diginfra_usage:"monitored_objects"`
	...
	MonthlySelectDataScannedGB         *float64 `diginfra_usage:"monthly_select_data_scanned_gb"`
	MonthlySelectDataReturnedGB        *float64 `diginfra_usage:"monthly_select_data_returned_gb"`
