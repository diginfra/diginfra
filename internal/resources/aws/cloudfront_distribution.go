...
type CloudfrontDistribution struct {
	...
	// "usage" args
	MonthlyHTTPRequests             *cloudfrontDistributionRegionRequestsUsage     `diginfra_usage:"monthly_http_requests"`
	MonthlyHTTPSRequests            *cloudfrontDistributionRegionRequestsUsage     `diginfra_usage:"monthly_https_requests"`
	MonthlyShieldRequests           *cloudfrontDistributionShieldRequestsUsage     `diginfra_usage:"monthly_shield_requests"`
	MonthlyInvalidationRequests     *int64                                         `diginfra_usage:"monthly_invalidation_requests"`
	MonthlyEncryptionRequests       *int64                                         `diginfra_usage:"monthly_encryption_requests"`
	MonthlyLogLines                 *int64                                         `diginfra_usage:"monthly_log_lines"`
	MonthlyDataTransferToInternetGB *cloudfrontDistributionRegionDataTransferUsage `diginfra_usage:"monthly_data_transfer_to_internet_gb"`
	MonthlyDataTransferToOriginGB   *cloudfrontDistributionRegionDataTransferUsage `diginfra_usage:"monthly_data_transfer_to_origin_gb"`
	CustomSslCertificates           *int64                                         `diginfra_usage:"custom_ssl_certificates"`
}

type cloudfrontDistributionRegionDataTransferUsage struct {
	US           *float64 `diginfra_usage:"us"`
	Europe       *float64 `diginfra_usage:"europe"`
	SouthAfrica  *float64 `diginfra_usage:"south_africa"`
	SouthAmerica *float64 `diginfra_usage:"south_america"`
	Japan        *float64 `diginfra_usage:"japan"`
	Australia    *float64 `diginfra_usage:"australia"`
	AsiaPacific  *float64 `diginfra_usage:"asia_pacific"`
	India        *float64 `diginfra_usage:"india"`
}

type cloudfrontDistributionRegionRequestsUsage struct {
	US           *int64 `diginfra_usage:"us"`
	Europe       *int64 `diginfra_usage:"europe"`
	SouthAfrica  *int64 `diginfra_usage:"south_africa"`
	SouthAmerica *int64 `diginfra_usage:"south_america"`
	Japan        *int64 `diginfra_usage:"japan"`
	Australia    *int64 `diginfra_usage:"australia"`
	AsiaPacific  *int64 `diginfra_usage:"asia_pacific"`
	India        *int64 `diginfra_usage:"india"`
}
...
type cloudfrontDistributionShieldRequestsUsage struct {
	...
	Japan        *int64 `diginfra_usage:"japan"`
	Australia    *int64 `diginfra_usage:"australia"`
	Singapore    *int64 `diginfra_usage:"singapore"`
	SouthKorea   *int64 `diginfra_usage:"south_korea"`
	Indonesia    *int64 `diginfra_usage:"indonesia"`
	India        *int64 `diginfra_usage:"india"`
}
