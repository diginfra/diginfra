...
import (
	...
	resources "github.com/diginfra/diginfra/internal/resources/aws"
...
func stubRequestCounts(stub *stubbedAWS, metric string, count int) {
	stub.WhenBody("Value=diginfra", fmt.Sprintf("MetricName=%s", metric), "Statistics.member.1=Sum", "Unit=Count").Then(200, fmt.Sprintf(`
	<GetMetricStatisticsResponse xmlns="http://monitoring.amazonaws.com/doc/2010-08-01/">
		<GetMetricStatisticsResult>
			<Label>%s</Label>
			<Datapoints>
...
func stubDataBytes(stub *stubbedAWS, metric string, bytes int) {
	stub.WhenBody("Value=diginfra", fmt.Sprintf("MetricName=%s", metric), "Statistics.member.1=Sum", "Unit=Bytes").Then(200, fmt.Sprintf(`
	<GetMetricStatisticsResponse xmlns="http://monitoring.amazonaws.com/doc/2010-08-01/">
		<GetMetricStatisticsResult>
			<Label>%s</Label>
			<Datapoints>
