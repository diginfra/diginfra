...
type MWAAEnvironment struct {
	...
	// If there is a parameter than needs to be read from diginfra-usage.yml you define it like this:
	AdditionalWorkers    *float64 `diginfra_usage:"additional_workers"`
	AdditionalSchedulers *float64 `diginfra_usage:"additional_schedulers"`
	MetaDatabaseGB       *float64 `diginfra_usage:"meta_database_gb"`
}
