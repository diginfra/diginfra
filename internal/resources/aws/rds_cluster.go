...
type RDSCluster struct {
	...
	WriteRequestsPerSec       *int64   `diginfra_usage:"write_requests_per_sec"`
	ReadRequestsPerSec        *int64   `diginfra_usage:"read_requests_per_sec"`
	ChangeRecordsPerStatement *float64 `diginfra_usage:"change_records_per_statement"`
	StorageGB                 *float64 `diginfra_usage:"storage_gb"`
	AverageStatementsPerHr    *int64   `diginfra_usage:"average_statements_per_hr"`
	BacktrackWindowHrs        *int64   `diginfra_usage:"backtrack_window_hrs"`
	SnapshotExportSizeGB      *float64 `diginfra_usage:"snapshot_export_size_gb"`
	CapacityUnitsPerHr        *float64 `diginfra_usage:"capacity_units_per_hr"`
	BackupSnapshotSizeGB      *float64 `diginfra_usage:"backup_snapshot_size_gb"`
}
