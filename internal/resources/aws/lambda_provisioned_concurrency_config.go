...
type LambdaProvisionedConcurrencyConfig struct {
	...
	MonthlyDurationHours *int64  `diginfra_usage:"monthly_duration_hrs"`
	MonthlyRequests      *int64  `diginfra_usage:"monthly_requests"`
	RequestDurationMS    *int64  `diginfra_usage:"request_duration_ms"`
	Architecture         *string `diginfra_usage:"architecture"`
	MemoryMB             *int64  `diginfra_usage:"memory_mb"`
}
