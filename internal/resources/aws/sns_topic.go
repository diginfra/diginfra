...
type SNSTopic struct {
	Address                 string
	Region                  string
	RequestSizeKB           *float64 `diginfra_usage:"request_size_kb"`
	MonthlyRequests         *int64   `diginfra_usage:"monthly_requests"`
	HTTPSubscriptions       *int64   `diginfra_usage:"http_subscriptions"`
	EmailSubscriptions      *int64   `diginfra_usage:"email_subscriptions"`
	KinesisSubscriptions    *int64   `diginfra_usage:"kinesis_subscriptions"`
	MobilePushSubscriptions *int64   `diginfra_usage:"mobile_push_subscriptions"`
	MacOSSubscriptions      *int64   `diginfra_usage:"macos_subscriptions"`
	SMSSubscriptions        *int64   `diginfra_usage:"sms_subscriptions"`
	SMSNotificationPrice    *float64 `diginfra_usage:"sms_notification_price"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the SNSTopic.
...
// It uses the `diginfra_usage` struct tags to populate data into the SNSFIFOTopic.
