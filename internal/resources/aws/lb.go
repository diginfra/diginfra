...
type LB struct {
	...
	Region            string
	RuleEvaluations   *int64   `diginfra_usage:"rule_evaluations"`
	NewConnections    *int64   `diginfra_usage:"new_connections"`
	ActiveConnections *int64   `diginfra_usage:"active_connections"`
	ProcessedBytesGB  *float64 `diginfra_usage:"processed_bytes_gb"`
}
