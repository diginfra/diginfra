...
type APIGatewayV2API struct {
	...
	Region                string
	ProtocolType          string
	MessageSizeKB         *int64 `diginfra_usage:"message_size_kb"`
	MonthlyConnectionMins *int64 `diginfra_usage:"monthly_connection_mins"`
	MonthlyRequests       *int64 `diginfra_usage:"monthly_requests"`
	RequestSizeKB         *int64 `diginfra_usage:"request_size_kb"`
	MonthlyMessages       *int64 `diginfra_usage:"monthly_messages"`
}
