...
type DXConnection struct {
	...
	Location                                        string
	Region                                          string
	MonthlyOutboundFromRegionToDXConnectionLocation *RegionsUsage `diginfra_usage:"monthly_outbound_from_region_to_dx_connection_location"`
	MonthlyOutboundRegionToDxLocationGB             *float64      `diginfra_usage:"monthly_outbound_region_to_dx_location_gb"`
	DxVirtualInterfaceType                          *string       `diginfra_usage:"dx_virtual_interface_type"`
	DXConnectionType                                *string       `diginfra_usage:"dx_connection_type"`
}
