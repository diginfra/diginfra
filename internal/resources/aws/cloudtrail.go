...
type Cloudtrail struct {
	...
	MonthlyAdditionalManagementEvents *float64 `diginfra_usage:"monthly_additional_management_events"`
	MonthlyDataEvents                 *float64 `diginfra_usage:"monthly_data_events"`
	MonthlyInsightEvents              *float64 `diginfra_usage:"monthly_insight_events"`
}
...
// It uses the `diginfra_usage` struct tags to populate data into the Cloudtrail.
