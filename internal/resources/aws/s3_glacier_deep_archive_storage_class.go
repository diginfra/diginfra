...
type S3GlacierDeepArchiveStorageClass struct {
	...
	MonthlyBulkDataRetrievalRequests     *int64   `diginfra_usage:"monthly_bulk_data_retrieval_requests"`
	MonthlyBulkDataRetrievalGB           *float64 `diginfra_usage:"monthly_bulk_data_retrieval_gb"`
