...
type GlobalacceleratorEndpointGroup struct {
	...
	MonthlyInboundDataTransferGB  *globalAcceleratorRegionDataTransferUsage `diginfra_usage:"monthly_inbound_data_transfer_gb"`
	MonthlyOutboundDataTransferGB *globalAcceleratorRegionDataTransferUsage `diginfra_usage:"monthly_outbound_data_transfer_gb"`
}
...
type globalAcceleratorRegionDataTransferUsage struct {
	...
	SouthKorea   *float64 `diginfra_usage:"south_korea"`
	Australia    *float64 `diginfra_usage:"australia"`
	AsiaPacific  *float64 `diginfra_usage:"asia_pacific"`
	MiddleEast   *float64 `diginfra_usage:"middle_east"`
