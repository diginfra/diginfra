...
type DBInstance struct {
	...
	MonthlyStandardIORequests                    *int64   `diginfra_usage:"monthly_standard_io_requests"`
	AdditionalBackupStorageGB                    *float64 `diginfra_usage:"additional_backup_storage_gb"`
