...
type S3GlacierFlexibleRetrievalStorageClass struct {
	...
	MonthlyTier1Requests                  *int64   `diginfra_usage:"monthly_tier_1_requests"`
	MonthlyTier2Requests                  *int64   `diginfra_usage:"monthly_tier_2_requests"`
	MonthlyLifecycleTransitionRequests    *int64   `diginfra_usage:"monthly_lifecycle_transition_requests"`
	MonthlyStandardDataRetrievalRequests  *int64   `diginfra_usage:"monthly_standard_data_retrieval_requests"`
	MonthlyStandardDataRetrievalGB        *float64 `diginfra_usage:"monthly_standard_data_retrieval_gb"`
	MonthlyStandardSelectDataScannedGB    *float64 `diginfra_usage:"monthly_standard_select_data_scanned_gb"`
	MonthlyStandardSelectDataReturnedGB   *float64 `diginfra_usage:"monthly_standard_select_data_returned_gb"`
	MonthlyExpeditedDataRetrievalRequests *int64   `diginfra_usage:"monthly_expedited_data_retrieval_requests"`
	MonthlyExpeditedDataRetrievalGB       *float64 `diginfra_usage:"monthly_expedited_data_retrieval_gb"`
	MonthlyExpeditedSelectDataScannedGB   *float64 `diginfra_usage:"monthly_expedited_select_data_scanned_gb"`
	MonthlyExpeditedSelectDataReturnedGB  *float64 `diginfra_usage:"monthly_expedited_select_data_returned_gb"`
	MonthlyBulkSelectDataScannedGB        *float64 `diginfra_usage:"monthly_bulk_select_data_scanned_gb"`
	MonthlyBulkSelectDataReturnedGB       *float64 `diginfra_usage:"monthly_bulk_select_data_returned_gb"`
	EarlyDeleteGB                         *float64 `diginfra_usage:"early_delete_gb"`
}
