...
type EFSFileSystem struct {
	...
	MonthlyInfrequentAccessReadGB  *float64 `diginfra_usage:"monthly_infrequent_access_read_gb"`
	MonthlyInfrequentAccessWriteGB *float64 `diginfra_usage:"monthly_infrequent_access_write_gb"`
}
