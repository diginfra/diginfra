...
type LaunchConfiguration struct {
	...
	InstanceCount                 *int64  `diginfra_usage:"instances"`
...
func (a *LaunchConfiguration) BuildResource() *schema.Resource {
	if strings.ToLower(a.Tenancy) == "host" {
		logging.Logger.Warn().Msgf("Skipping resource %s. Diginfra currently does not support host tenancy for AWS Launch Configurations", a.Address)
		return nil
