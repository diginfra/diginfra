...
type DynamoDBTable struct {
	...
	// "usage" args
	MonthlyWriteRequestUnits       *int64 `diginfra_usage:"monthly_write_request_units"`
	MonthlyReadRequestUnits        *int64 `diginfra_usage:"monthly_read_request_units"`
	StorageGB                      *int64 `diginfra_usage:"storage_gb"`
	PitrBackupStorageGB            *int64 `diginfra_usage:"pitr_backup_storage_gb"`
	OnDemandBackupStorageGB        *int64 `diginfra_usage:"on_demand_backup_storage_gb"`
	MonthlyDataRestoredGB          *int64 `diginfra_usage:"monthly_data_restored_gb"`
	MonthlyStreamsReadRequestUnits *int64 `diginfra_usage:"monthly_streams_read_request_units"`
}
