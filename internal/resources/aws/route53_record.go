...
type Route53Record struct {
	Address                    string
	IsAlias                    bool
	MonthlyLatencyBasedQueries *int64 `diginfra_usage:"monthly_latency_based_queries"`
	MonthlyGeoQueries          *int64 `diginfra_usage:"monthly_geo_queries"`
	MonthlyStandardQueries     *int64 `diginfra_usage:"monthly_standard_queries"`
}
