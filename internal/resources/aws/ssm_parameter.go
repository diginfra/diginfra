...
type SSMParameter struct {
	...
	Tier                   string
	Region                 string
	ParameterStorageHrs    *int64  `diginfra_usage:"parameter_storage_hrs"`
	APIThroughputLimit     *string `diginfra_usage:"api_throughput_limit"`
	MonthlyAPIInteractions *int64  `diginfra_usage:"monthly_api_interactions"`
}
