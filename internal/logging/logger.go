...
var (
	...
	// to ensure that logging functionality is consistent across the Diginfra codebase.
	//
...
// This is used so that the logging packages does not use any other Diginfra packages,
