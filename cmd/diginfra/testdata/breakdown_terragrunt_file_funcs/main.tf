...
locals {
  files = [
    ...
    {
      name = "abs",
      file = "/home/runner/work/diginfra/diginfra/cmd/diginfra/testdata/breakdown_terraform_file_funcs/instance.json",
    },
    { name = "pdabs", file = "/home/runner/work/diginfra/diginfra/cmd/testdata/instance.json", },
  ]
  dirs = [
    { name = "cd", dir = "." },
    { name = "pd", dir = "../../../testdata" },
    { name = "abs", dir = "/home/runner/work/diginfra/diginfra/cmd/diginfra/testdata/breakdown_terraform_file_funcs/" },
    { name = "pdabs", dir = "/home/runner/work/diginfra/diginfra/cmd/testdata/" },
  ...
  template_files = [
    ...
    {
      name = "abs", file = "/home/runner/work/diginfra/diginfra/cmd/diginfra/testdata/breakdown_terraform_file_funcs/templ.tftpl",
    },
    { name = "pdabs", file = "/home/runner/work/diginfra/diginfra/cmd/testdata/templ.tftpl", }
  ]
}
