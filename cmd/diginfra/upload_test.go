...
func TestUploadWithPathFormatJSON(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		fmt.Fprintln(w, `[{"data": {"addRun":{
		  ...
		  "shareUrl": "",
		  "cloudUrl": "https://infra-dashboard.khulnasoft.com/org/tim/repos/4e936c53-6091-4836-82da-e106ff653aec/runs/ff050cb8-eaaa-479f-8865-3fc0fd689b9f",
		  "pullRequestUrl": "https://infra-dashboard.khulnasoft.com/org/tim/repos/4e936c53-6091-4836-82da-e106ff653aec/pulls/null",
