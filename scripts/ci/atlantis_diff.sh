...
#
# Please follow our guide: https://www.diginfra.khulnasoft.com/docs/guides/atlantis_migration/ to migrate
# to our new Atlantis integration: https://github.com/diginfra/diginfra-atlantis
#
...
if [ "$atlantis_debug" = "true" ] || [ "$atlantis_debug" = "True" ] || [ "$atlantis_debug" = "TRUE" ]; then
  ...
  echo "Please visit https://www.diginfra.khulnasoft.com/docs/guides/atlantis_migration/ for instructions on how to upgrade."
  echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
  echo

  echo "#####"
  echo "Running Diginfra atlantis_diff.sh in debug mode, remove atlantis_debug=true from Atlantis configs to disable debug outputs."
  echo
fi
...
process_args () {
  ...
  export DIGINFRA_CI_ATLANTIS_DIFF=true
}
