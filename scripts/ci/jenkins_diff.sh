...
#
# Please migrate to our new Jenkins integration: https://github.com/diginfra/diginfra-jenkins
#
...
echo "Please visit https://github.com/diginfra/diginfra-jenkins/ for the new recommended way of using Diginfra in Jenkins."
echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
...
process_args () {
  ...
  export DIGINFRA_CI_JENKINS_DIFF=true
...
build_msg_html () {
  # TODO: change it to diginfra output once https://github.com/diginfra/diginfra/issues/509 is resolved.
  msg=$1
...
cleanup () {
  # Don't delete diginfra_diff.html here as Jenkinsfile publishes that
